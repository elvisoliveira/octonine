...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/octonine.exe: ${OBJECTFILES}
	...
	g++.exe -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/octonine ${OBJECTFILES} ${LDLIBSOPTIONS} -L/usr/local/lib

${OBJECTDIR}/downloadfeed.o: downloadfeed.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/downloadfeed.o downloadfeed.cpp
...
${OBJECTDIR}/parsefeed.o: parsefeed.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parsefeed.o parsefeed.cpp
